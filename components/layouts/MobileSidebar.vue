...
<template>
    <div class="mobile-header-active mobile-header-wrapper-style" :class="{ 'sidebar-visible': isOpened }"
        ref="mobileSidebar">
        <div class="clickalbe-sidebar-wrap">
            <a class="sidebar-close" @click="emits('close')"><i class="fa-light fa-xmark"></i></a>
