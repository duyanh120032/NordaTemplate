                        ...
                        <div id="des-details1" class="tab-pane " :class="{active : isActive=== 'des-details1' }">
                            <div class="description-wrap">
                                ...
                                <p> advanced performance metrics for endurance sports, Garmin quality navigation
                                    ...
                                    design in a
                                    highly evolved timepiece that fits your style anywhere, anytime. Solid brushed 316L
                                    stainless steel case with brushed stainless steel bezel and integrated EXOTM antenna
                                    for
                                    GPS + GLONASS support. High-strength scratch resistant sapphire crystal. Brown
                                    vintage
                                    leather strap with hand-sewn contrast stitching and nubuck inner lining and quick
                                    release
                                    mechanism.</p>
                            </div>
                        </div>
                                ...
                                <div class="single-review">
                                    ...
                                    <div class="review-content">
                                        ...
                                        <p>Donec accumsan auctor iaculis. Sed suscipit arcu ligula, at egestas magna
                                            molestie
                                            a. Proin ac ex maximus, ultrices justo eget, sodales orci. Aliquam egestas
                                            libero ac
